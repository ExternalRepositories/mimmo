 ...
 * The different behavior can be controlled by a set method (setParallel).
 ...
 * - <B>Parallel</B>: set if the read geometry is parallel true 1/false 0;
...
protected:
    ...
    bool        m_parallel;               /**<Set if the geometry to read is parallel. */
...
public:
    ...
    void        setParallel(bool parallel = MIMMO_ENABLE_MPI);
